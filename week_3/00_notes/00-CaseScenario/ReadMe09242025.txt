Create the API application with the following description:
    https://fastapi.tiangolo.com/

    1. Use the url endpoint : http://###############/get_employee
    2. Read content the content of a CSV file line by line 
...
Create an HTML application
    ...
    1. Review on the above platform
